...
class ClaimDetails(models.Model):
    """This class creates a model 'claim.details' and add fields for it"""
    _name = 'claim.details'
    _description = "Claim Details"

    name = fields.Char(
        string='Name', copy=False, readonly=True, index=True,
        default=lambda self: _('New'), help="Sequence for claim details")
